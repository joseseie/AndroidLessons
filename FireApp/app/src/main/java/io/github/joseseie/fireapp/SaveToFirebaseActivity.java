...
public class SaveToFirebaseActivity extends AppCompatActivity {
...
//                        .child(Helper.USER_profession) //Column(s)
                ...
                databaseReference.addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        Toast.makeText(SaveToFirebaseActivity.this,"Child added",Toast.LENGTH_LONG).show();
                    ...
                    public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                        ...
                        Toast.makeText(SaveToFirebaseActivity.this,"Child Charged",Toast.LENGTH_LONG).show();
                    ...
                    public void onChildRemoved(DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(SaveToFirebaseActivity.this,"Child Removed",Toast.LENGTH_LONG).show();
