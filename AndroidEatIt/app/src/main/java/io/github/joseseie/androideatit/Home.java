...
import io.github.joseseie.androideatit.model.Category;
import io.github.joseseie.androideatit.viewHolder.MenuViewHolder;
    ...
    private void loadMenu() {
        FirebaseRecyclerAdapter<Category, MenuViewHolder> adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(Category.class, R.layout.menu_item, MenuViewHolder.class, category) {
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                final Category cllickItem = model;
                viewHolder.setItemClickListener(new ItemClickListener() {
                    @Override
                    public void onClick(View view, int position, boolean isLongClick) {
                        Toast.makeText(Home.this, ""+cllickItem.getName(), Toast.LENGTH_LONG).show();
                    }
                });
